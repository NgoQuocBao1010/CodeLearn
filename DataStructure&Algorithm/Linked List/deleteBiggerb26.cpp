...
// Delete all element which is bigger than element at index k
// The easier way is to create another list to contains all the element
// which is smaller than k
void deleteBigger(List l){
    int k;
    cin >> k;

    Node* chosenElement = getNode(k, l);
